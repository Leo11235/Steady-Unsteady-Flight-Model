...
def run_PROPEP(rocket_inputs, rocket_parameters):
    # get values from dictionaries
    fuel_name = rocket_inputs["solid fuel type"]
    oxidizer_name = rocket_inputs["liquid oxidizer type"]
    OF_ratio =rocket_inputs.get("average oxidizer to fuel ratio") or rocket_parameters.get("average oxidizer to fuel ratio")
