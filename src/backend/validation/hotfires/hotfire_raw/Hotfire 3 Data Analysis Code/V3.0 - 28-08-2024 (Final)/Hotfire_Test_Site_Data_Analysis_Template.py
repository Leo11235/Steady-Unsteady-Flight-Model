...
Author: Esteban Perreault
The goal of this Python script is the reproduce Lewis Makay's original data 
analysis code, originally implemented in a Jupyter Notebook. The author 
dislikes this IDE and as such copy-pasted all of the code into a python file.
No modifications to the orignal code were made whatsoever. 
"""
