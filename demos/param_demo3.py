'''
create a 3-D graph of Isp vs chamber pressure on a range of 300-700 psi with a step size of 100, 
AND OF Ratio from 2 to 5 with a step size of 1
'''
import os, sys, json
...
parametric_inputs = {
    ...
    "variables to parametrize": [0,1,1,0,0,0,0,0,0], # either 1 or 0;;;; will eventually just change this to be directly a list of the actual variables we want to parametrize rather than just 1 or 0
    # variables below
