...
references = [
    ...
    # ["2.1", -1, -1],
    ["2.2", 7380, 7400, "col11"], # something else (not included? only goes to col18)
    ["2.3", 4775, 4850, "col18"],
    ["2.4", 3600, 3820, "col18"],
    # ["2.5", -1, -1],
    ["2.6", 4300, 4375, "col18"], # possibly sthg else
    ["2.7", 3450, 3525, "col18"],
    # ["2.8", -1, -1],
    ["3.1", 4675, 4735, "col18"],
    # ["3.2", 4570, 4610],
...
def read_write_raw_processed_jsonc (path, reference_list):
    ...
    output_dic['cc_pressure'] = dic[reference_list[3]]
    #if (reference_list[0] == "4.1"): output_dic['cc_pressure'] = [1000 * i for i in output_dic['cc_pressure']]
